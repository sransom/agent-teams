...
**Option A — add a step to an existing formula.** Edit `~/.claude/formulas/full-team.formula.json` to add a parallel review step that runs alongside `review` and `codex-review`:
